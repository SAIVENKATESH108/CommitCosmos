...
export default async function HomePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden flex flex-col" style={{ background: '#02000a' }}>
      ...
      {/* ── Ambient nebula background (static — no Math.random) ── */}
      <div aria-hidden="true" className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        {/* Cyan accent */}
        <div
          className="absolute top-1/3 -right-40 w-[600px] h-[600px] rounded-full animate-glow-pulse"
        ...
        />
        {/* Client-only star field (seeded, no hydration mismatch) */}
        <StarField count={60} />
      </div>
      ...
      <header
        ...
        style={{ background: 'rgba(2,0,10,0.7)', backdropFilter: 'blur(20px)' }}
      >
      ...
      <main className="relative z-10 flex-1">
        <section className="mx-auto max-w-6xl px-4 sm:px-6 pt-20 sm:pt-32 pb-16 text-center flex flex-col items-center">
          ...
          <div className="mt-16 w-full max-w-5xl relative group">
            <div
              className="absolute -inset-1 rounded-3xl opacity-40 group-hover:opacity-70 transition duration-1000 blur-xl animate-shimmer"
              style={{ background: 'linear-gradient(135deg, #7c3aed, #06b6d4, #7c3aed)', backgroundSize: '200% auto' }}
            />
            <div
              className="relative rounded-3xl overflow-hidden shadow-2xl animate-levitate"
              style={{ border: '1px solid rgba(255,255,255,0.1)', background: '#000' }}
            >
              <Image
                src="/commitcosmos_banner.png"
                alt="CommitCosmos 3D Galaxy Visualization"
                width={1200}
                height={630}
        ...
        {/* ── Stats Banner ── */}
        <section
          className="relative z-10 py-8 border-y border-white/[0.06]"
        ...
        {/* ── Feature Cards (client component — has hover event handlers) ── */}
        <section className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 text-sm max-w-xl mx-auto">
              Three powerful primitives that transform raw Git history into a living universe.
            </p>
          </div>
          <FeatureCards />
        </section>
      ...
      <footer
        ...
        style={{ background: 'rgba(2,0,10,0.8)' }}
      >
